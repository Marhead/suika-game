...
class CustomBody {
    ...
    constructor(body: Matter.Body, index: number) {
        this.body = body;
        this.index = index;
    }
}
...
const GameComponent: React.FC = () => {
    ...
    useEffect(() => {
        ...
        let currentBody: CustomBody = null;
        ...
        function addFruit() {
            ...
            const customBody = new CustomBody(
                Matter.Bodies.circle(300, 50, fruit.radius, {
                    isSleeping: true,
                    render: {
                        sprite: {
            ...
            Matter.World.add(world, customBody.body);
        }
